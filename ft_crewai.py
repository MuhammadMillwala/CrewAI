...
PROMPT = "tell me about badam pak"
...
precisely. If asked about other random things other than FT Sweets answer with I dont know.""",
agent=researcher
)
...
response as output donot include and make sure that you answer in a first person perspective also make sure
to answer queries that are only for FT sweets if asked about other random things answer with i dont know.""",
agent=writer
)
